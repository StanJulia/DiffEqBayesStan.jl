...
pars1  = read_samples(bayesian_result.model, output_format=:particles)

# ╔═╡ e781242a-3351-48da-bf50-b976d0c18390
DataFrame(pars1)

# ╔═╡ c52c391f-fc77-4dfe-ade0-8ffd2ccd6877
if success(bayesian_result.return_code)
...
git-tree-sha1 = "8d54313877cfbb03694aaeacf13f6f9912c459b3"
